...
That script filters out species without HSPs and rRNA annotation and creates the
03_species_with_rRNA_and_HSPs_annotation which includes all the species that
will be used for the analysis.

The following steps will create the GO annotation files and MongoDB collections.
'''
