...
Given the execution of step 00, here, proteomes without annotated HSP40 and HSP70
are filtered out and the final list is ranked according to the amount of
annotated terms and the numer of genes.

Output: 01_ranked_species_based_on_genomic_annotation.ts
'''
