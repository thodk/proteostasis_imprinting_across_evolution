...
if __name__ == '__main__':
    ...
    the 20 conserved mechanisms. The 'heatmap' module is used for this process 
    (called from the upper directory). This is a custom module which is based 
    on 'seaborn.clustergram' and configures appropriately the plot for these 
    specific data.
    '''
