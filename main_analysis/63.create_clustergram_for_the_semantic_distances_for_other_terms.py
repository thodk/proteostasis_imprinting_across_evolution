...
if __name__ == '__main__':
    ...
    the 20 conserved mechanisms. The 'heatmap.py' script is used for this process 
    (called from the upper directory). It contains a workflow which is based on 
    'seaborn.clustergram' and configures appropriately the data to create the plot.
    '''
