...
if __name__ == '__main__':
    ...
    #c.clustergrid.savefig('./rRNAs_analysis/rRNAs_clustergram.tiff', dpi=600, format='tiff',
                          #pad_inches=0.02)
    c.clustergrid.savefig('./rRNAs_analysis/rRNAs_clustergram.png', dpi=900, format='png',
                          pad_inches=0.02)