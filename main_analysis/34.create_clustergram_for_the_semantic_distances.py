...
if __name__ == '__main__':
    ...
    This script is used to illustrate the PN-semantic distance matrix as a heatmap 
    ...
    df = pandas.read_csv(main_dir+'final_distance_matrix.tsv', 
                         sep='\t', index_col=0)
    matrix = df.values
    ...
    #c.clustergrid.savefig(main_dir+'PN_clustergram', dpi=900, format='tiff',
    #                  pad_inches=0.02)
    c.clustergrid.savefig(main_dir+'PN_clustergram.png', dpi=900, format='png',
                          pad_inches=0.02)
