...
def worker(hsp):
    ...
    #c.clustergrid.savefig(main_dir+hsp+'_clustergram.tiff', dpi=900, format='tiff',
                      #pad_inches=0.02)
    c.clustergrid.savefig(main_dir+hsp+'_clustergram.png', dpi=900, format='png',
                      pad_inches=0.02)
...
if __name__ == '__main__':
    ...
    This script is used to illustrate the HSPs distance matrix as a heatmap and
