...
# DESCRIPTION:
# 
# That script retrieves annotation for HSPs from the Ensembl database. The worker 
...
# data retrieved from the UniProt database (see 10A.get_HSPs_annotation_from_uniprot.py)
